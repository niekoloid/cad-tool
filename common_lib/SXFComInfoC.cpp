/**
	...
	SXFComInfoC.cpp						作成日：2000.03.17
...
/**
	...
	２．インターフェイス
		void	 SXFComInfoC::Set_Write_Come(char IN_fname[257], 
											int IN_flg, 
											double IN_tolerance, 
...
/**
	...
	２．インターフェイス
		void	 SXFComInfoC::Set_Read_Come(char IN_fname[257], 
											int IN_flg, 
											double IN_tolerance, 
											double IN_tolerance2, 
											double IN_devide, 
...
/**
	All Rights Reserved,(c)JACIC 2001
	SXFComInfoC.cpp						作成日：2000.04.24
...
/**
	...
	１．機能概要
		ファイルの情報と呼び出し情報を比較チェックし、不整合を通知する
		(ワーニング処理)

/**
	...
	SXFExHatch_checkC.cpp								作成日：2000.4.3
										  	...
										  	SXFComInfoC* IN_Info)
{
	...
	m_feature_name = "EXTERNALLY_DEFINED_HATCH";
	...
	//READ
	if (RW_Flag == 0){
		ret = ReadFeature_Check(IN_exhatch_str);
	}
	//WRITE
	else if (RW_Flag == 1){
...
**/
int SXFExhatch_checkC::ReadFeature_Check(Externally_Defined_Hatch_Struct *IN_Struct)
{
	//外形のフィーチャコードが定義されていない値のとき
